...
source.open('C:\\Users\\Raul\\OneDrive\\Escritorio\\TFG\\version dev\\LeagueAI-development\\generate_dataset\\DATASET_SERIO\\'+ SOURCE_FILENAME+'.mkv')
...
resize = True
try:
    x_pixel = int(input("Enter the output resolution X-axis in pixels. 0 means native resolution.\n"))
except Exception:
    resize = False
